...
//WP_Bakery sortcode
//Sort code
add_shortcode('bartag','funtion_book_listing');


//sortcode callback
add_action( 'wp_enqueue_scripts', 'my_admin_ajax' );
function funtion_book_listing( $atts ) {
...
//VS_map with plugin
add_action('vc_before_init', 'wp_bakery_sortcode_callback');
function wp_bakery_sortcode_callback()
{
    vc_map(array(
        "name"              => __("Bookss", "text-domain"),
        "base"              => "bartag",
        "class"             => "",
        ...
        "params" => array(
            array(
                ...
                "param_name"    => "category",
                "value"         => __("all", "text-domain"),
                "description"   => __("category of book that will be displayed on front end.", "my-text-domain")
            ),
            array(
                "type"          => "textfield",
                "holder"        => "div",
                ...
                "param_name"    => "count",
                "value"         => __("5", "text-domain"),
                "description"   => __("Number of books to be displayed", "text-domain")
            )
        )
    ));
}
